...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const schema = joi_1.default.object({
            ...
            price: joi_1.default.number().greater(0).custom((value, helper) => {
                if (value > 1000) {
            ...
            qtd_stock: joi_1.default.number().custom((value, helper) => {
            ...
            bar_codes: joi_1.default.string().custom((value, helper) => {
                if (value.length !== 13) {
        ...
        const resultPatch = yield productSchema_1.default.findByIdAndUpdate({ _id: id }, schema);
